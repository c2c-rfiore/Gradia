...
class ImageSidebar(Adw.Bin):
    ...
    save_preset_revealer: Gtk.Revealer = Gtk.Template.Child()
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.background_selector.attach_preset_save_button(
            self.save_preset_button, self.save_preset_revealer
        )
